...
#define RPM_RADIUS 225 * WINDOW_RESOLUTION_FACTOR
#define RPM_X WINDOW_WIDTH / 4 - RPM_RADIUS / 2
#define RPM_Y WINDOW_HEIGHT / 2 - RPM_RADIUS / 2
...
#define OIL_WIDTH 100 * WINDOW_RESOLUTION_FACTOR
#define OIL_HEIGHT 100 * WINDOW_RESOLUTION_FACTOR
#define OIL_X WINDOW_WIDTH / 1.25f - OIL_WIDTH / 2
#define OIL_Y WINDOW_HEIGHT * 0.75f - OIL_HEIGHT / 2

#define TEMPERATURE_WIDTH 100 * WINDOW_RESOLUTION_FACTOR
#define TEMPERATURE_HEIGHT 100 * WINDOW_RESOLUTION_FACTOR
#define TEMPERATURE_X WINDOW_WIDTH / 1.25f - TEMPERATURE_WIDTH / 2
#define TEMPERATURE_Y WINDOW_HEIGHT * 0.25f - TEMPERATURE_HEIGHT / 2

/* Value limits */
#define SPEEDOMETER_MIN_VALUE 0.0f
#define SPEEDOMETER_MAX_VALUE 200.0f

#define RPM_MIN_VALUE 0.0f
#define RPM_MAX_VALUE 8000.0f
...
// macro for getting the multiplication factor for two value limits (used on config ui for automatically setting values)
